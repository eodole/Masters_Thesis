...
#import dataset 
library(readr)
# full_data <- read_csv("Desktop/Masters_Thesis/Py_Code/gen_data/random_er_dag/experiment4_data.csv",  col_names = FALSE)
...
res6  %>% filter(indep_test %in% c("1,10|", "4,8|", "4,8|1"))%>% ggplot(aes(x = alpha, y = z_score)) + 
